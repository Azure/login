...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!!cloud) {
                yield executeAzCliCommand(`cloud set --name "${cloud}"`, true);
            }
            ...
            if (enableAzPSSession) {
                ...
                const spnlogin = new ServicePrincipalLogin_1.ServicePrincipalLogin(servicePrincipalId, servicePrincipalKey, tenantId, subscriptionId, cloud);
