...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield executeAzCliCommand("--version", false, execOptions);
            ...
            if (environment == "azurestack") {
                ...
                try {
                    yield executeAzCliCommand(`cloud set -n AzureCloud`, false);
            ...
            yield executeAzCliCommand(`login`, false, loginOptions, commonArgs);
            if (!allowNoSubscriptionsLogin) {
                var args = [
                    "--subscription",
                    subscriptionId
                ];
                yield executeAzCliCommand(`account set`, false, loginOptions, args);
            }
            isAzCLISuccess = true;
