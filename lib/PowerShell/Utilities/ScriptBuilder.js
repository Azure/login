...
class ScriptBuilder {
    ...
    getAzPSLoginScript(scheme, tenantId, args, userManagedIdentityResourceId) {
        ...
        if (scheme === Constants_1.default.SystemManagedIdentity) {
            command += `Connect-AzAccount -Identity | out-null`;
        }
        if (scheme === Constants_1.default.UserManagedIdentity && userManagedIdentityResourceId) {
