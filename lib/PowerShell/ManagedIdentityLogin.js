...
class ManagedIdentityLogin {
    constructor(userManagedIdentityResourceId) {
        this.scheme = Constants_1.default.SystemManagedIdentity;
        this.userManagedIdentityResourceId = userManagedIdentityResourceId;
        if (userManagedIdentityResourceId) {
            this.scheme = Constants_1.default.UserManagedIdentity;
        }
    }
    initialize() {
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const args = {};
            const script = new ScriptBuilder_1.default().getAzPSLoginScript(this.scheme, null, args, this.userManagedIdentityResourceId);
...
exports.ManagedIdentityLogin = ManagedIdentityLogin;
